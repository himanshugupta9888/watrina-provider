...
class Enums {
    ...
    companion object {
        ...
        const val VERIFY_OTP_CODE: Int = 122
    ...
    @IntDef(VERIFY_OTP_CODE, GOOGLE_REQ_CODE, RC_COUNTRY_CODE_PICKER, RC_GOOGLE_SIGN_IN, COUNTRYLIST_REQUEST_CODE, CITYLIST_REQUEST_CODE, FILE_REQ_CODE)
