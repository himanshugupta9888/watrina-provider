...
import com.gox.partner.utils.Enums.Companion.VERIFY_OTP_CODE
...
class RegistrationActivity : BaseActivity<ActivityRegisterBinding>(),
    ...
    override fun initView(mViewDataBinding: ViewDataBinding?) {
        ...
        // WHEN YOU REQUIRED ENABLE THIS METHOD OTHERWISE DON'T CALL
       // generateHash()
...
//            resultIntent.putExtra("countryName", "Australia")
//            resultIntent.putExtra("countryCode", "+61")
//            resultIntent.putExtra("countryFlag", R.drawable.flag_australia)
//        } else {
    ...
    private fun getApiResponse() {
        ...
        mViewModel.sendOTPResponse.observe(this, androidx.lifecycle.Observer {
            ...
            Handler().postDelayed({
                ...
                startActivityForResult(intent,VERIFY_OTP_CODE)
            },1000)
        });
    }
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                ...
                for (signature in info.signatures) {
                    md.update(signature.toByteArray())
                    val signatureBase64 = String(Base64.encode(md.digest(), 0))
                    Log.i("KEY HASH : ", signatureBase64)
                }
            }
