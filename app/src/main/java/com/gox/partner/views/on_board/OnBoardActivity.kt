...
class OnBoardActivity : BaseActivity<ActivityOnBoardBinding>()
    ...
    override fun initView(mViewDataBinding: ViewDataBinding?) {
        ...
        list.add(WalkThrough(R.drawable.bg_walk_one_2,
                getString(R.string.walk_1), getString(R.string.walk_1_description)))
        list.add(WalkThrough(R.drawable.bg_walk_two_2,
                getString(R.string.walk_2), getString(R.string.walk_2_description)))
        list.add(WalkThrough(R.drawable.bg_walk_three_2,
    ...
    private fun loadAdapter() {
        ...
        val imageId = intArrayOf(R.drawable.bg_walk_one_2, R.drawable.bg_walk_two_2, R.drawable.bg_walk_three_2)
